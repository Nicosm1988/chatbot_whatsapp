...
test("mapea vacunas a programa obesidad y diabetes para cliente", () => {
  const tags = mergeConversationContextTags([], {
    mode: "DELIVERY",
    orderType: "VACUNAS"
  });
  ...
  assert.equal(buildSummaryFromContext({ mode: "DELIVERY", orderType: "VACUNAS", items: 2 }), "Delivery | Programa obesidad y diabetes | 2 items");
});
